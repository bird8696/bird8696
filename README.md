...
![API Security](https://img.shields.io/badge/API_Security-d6eaff?style=flat-square)
![Malware Analysis](https://img.shields.io/badge/Malware_Analysis-d6fff4?style=flat-square)
...
위험도 3단계 분류 `LOW` `MEDIUM` `HIGH` · FastAPI + Pydantic REST API 설계.
