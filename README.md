...
<img src="https://capsule-render.vercel.app/api?type=soft&color=0:ffd6e7,50:d6eaff,100:e8d6ff&height=200&section=header&text=TaeHyun%20Kim&fontSize=48&fontColor=7c6fa0&fontAlignY=45&desc=✦%20Security%20Engineer%20in%20Training%20✦&descAlignY=68&descSize=15&descColor=a598c8&animation=fadeIn" width="100%"/>
...
<img src="https://avatars.githubusercontent.com/u/99649668?v=4" width="110" style="border-radius:50%"/>

<br/>

**`김태현 (TaeHyun Kim)`**

[![Gmail](https://img.shields.io/badge/✉%20kthkmj00%40gmail.com-ffd6e7?style=flat-square&logoColor=white&labelColor=ffb3d1&color=ffd6e7)](mailto:kthkmj00@gmail.com)
&nbsp;
[![GitHub](https://img.shields.io/badge/🐙%20bird8696-d6eaff?style=flat-square&labelColor=b3d4ff&color=d6eaff)](https://github.com/bird8696)

<br/>

![Typing SVG](https://readme-typing-svg.demolab.com?font=M+PLUS+Rounded+1c&size=14&pause=1200&color=a598c8&center=true&width=460&lines=Network+Security+🔐+·+Cloud+Security+☁️;AI-Powered+Threat+Detection+🤖;Vulnerability+Analysis+%26+Pentesting+🛡️;SK+Shields+Rookies+31st+✨)
...
role    : Security Engineer (In Training) 🛡️
vibe    : 낮에는 보안 공부, 밤에는 덕질 🌙
focus   :
  - 🔐 Network / Cloud / Application Security
  - 🤖 AI-Powered Malware & Log Analysis
  - 🔍 Vulnerability Assessment & Pentesting
status  : 🌸 Learning @ SK쉴더스 루키즈 31기
```
...
`EC2` &nbsp; `S3` &nbsp; `IAM` &nbsp; `RDS` &nbsp; `Docker` &nbsp; `Linux Server`
...
`Threat Detection` &nbsp; `Log Analysis` &nbsp; `API Security` &nbsp; `Malware Analysis`
...
![Claude API](https://img.shields.io/badge/Claude_API-ffd6e7?style=flat-square&logo=anthropic&logoColor=c97b9a)
![VirusTotal](https://img.shields.io/badge/VirusTotal-d6eaff?style=flat-square&logo=virustotal&logoColor=6a9ec9)
...
VirusTotal · SafeBrowsing API · GPT-4o-mini RAG 통합으로 위협 인텔리전스 자동화.

- 🌸 FastAPI 서버 구축 및 다중 에이전트 오케스트레이션 설계
- 🌸 VirusTotal / SafeBrowsing API 통합 및 Intel Agent 구현
...
Claude AI 기반 Zero-Shot 피싱 이메일 자동 분석 API 서버.
...
![Streamlit](https://img.shields.io/badge/Streamlit-ffe8d6?style=flat-square&logo=streamlit&logoColor=c9956a)
![GitHub Actions](https://img.shields.io/badge/Actions-d6eaff?style=flat-square&logo=githubactions&logoColor=6a9ec9)

🌐 [`ktx-delay-predictor.streamlit.app`](https://ktx-delay-predictor.streamlit.app) &nbsp;|&nbsp; [`bird8696/ktx-delay-predictor`](https://github.com/bird8696/ktx-delay-predictor)

Korail API + scikit-learn 기반 KTX 연착 예측 모델 및 실시간 대시보드.
...
| 💜 프로젝트 | 설명 | 기술 |
|------------|------|------|
| 🎙️ 음성 인식 프로그램 | TTS / STT 학습 프로젝트 | Python |
| 🤖 Tabi 챗봇 | NLTK 기반 GUI 챗봇 | Python · Tkinter |
| 📱 Short Notes | 다목적 Android 앱 | Java · Android |
| 🎮 Choice Free Game | 이세계 아이돌 선택지 게임 | JavaScript |
...
<img src="https://capsule-render.vercel.app/api?type=soft&color=0:e8d6ff,50:ffd6e7,100:d6eaff&height=100&section=footer&text=✦%20thanks%20for%20visiting%20✦&fontSize=18&fontColor=a598c8&animation=fadeIn" width="100%"/>
